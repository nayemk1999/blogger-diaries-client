    ...
    return (
        <div className='talk-section'>
            <div className='talk-section-content'>
                ...
                Handover all your requirements to our Blogger experts who've curated more than 200 itineraries.
                </div>
                <a href="#" alt="" className='talkBtn'>Talk to our expert</a>
                <div className='talk-bottom'>P.S.- We love talking about Blogger 24*7</div>
